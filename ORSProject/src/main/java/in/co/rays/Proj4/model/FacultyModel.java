...
/**
 * FacultyModel handles all CRUD operations related to the Faculty entity.
 * It interacts with the database using JDBC and manages faculty data such as 
 * adding, updating, deleting, and retrieving faculty records.
 * <p>
 * This model also handles validation like checking for duplicate email IDs.
 * </p>
 *
...
public class FacultyModel {
    ...
    /**
     * Gets the next primary key for the faculty table.
     *
     ...
     * Also sets college name, course name, and subject name from their respective models.
     *
     * @param bean the FacultyBean containing data to be inserted
     * @return the generated primary key of the inserted faculty
     * @throws Exception if any error occurs
     * @throws DuplicateRecordException if the email already exists
     */
     ...
     * Also updates college, course, and subject names.
     *
     * @param bean the FacultyBean containing updated data
     * @throws Exception if any error occurs
     * @throws DuplicateRecordException if the updated email already exists in another record
     */
     ...
     *
     * @param bean the FacultyBean containing the ID of the faculty to be deleted
     * @throws Exception if any error occurs
     */
	public void delete(FacultyBean bean ) throws Exception {
	  ...
	  /**
     * Finds a Faculty by its primary key (ID).
     *
     * @param id the ID of the faculty
     * @return the FacultyBean object if found, otherwise null
     * @throws Exception if any error occurs
     */
     ...
     * Supports filtering by first name and date of birth, and includes pagination.
     *
     * @param bean     the FacultyBean containing search criteria
     * @param pageNo   current page number
     * @param pageSize number of records per page
     * @return a list of FacultyBean objects matching the search
     * @throws Exception if any error occurs
     */
