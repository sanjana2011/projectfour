...
/**
 * The {@code MarksheetModel} class provides operations for managing student marksheet records
 * in the database. It supports typical CRUD operations such as add, update, delete, and search.
 * It also allows fetching a merit list and checking for duplicate roll numbers.
 *
 * <p>
 * This model interacts with:
 * <ul>
 *     <li>{@code MarksheetBean} - to carry data between layers</li>
 *     <li>{@code StudentModel} - to retrieve student details</li>
 *     <li>{@code JDBCDataSource} - for connection pooling</li>
 * </ul>
 * </p>
 *
...
public class MarksheetModel {
	 /**
     * Gets the next primary key (ID) from the database.
     *
     ...
     *
     * @param bean the {@code MarksheetBean} containing marksheet data
     * @return the primary key of the newly inserted record
     * @throws ApplicationException if any exception occurs during the operation
     * @throws DuplicateRecordException if a marksheet with the same roll number already exists
     */
     ...
     *
     * @param bean the {@code MarksheetBean} containing updated data
     * @throws ApplicationException if any exception occurs during the operation
     * @throws DuplicateRecordException if the updated roll number already exists in another record
     */
     ...
     *
     * @param bean the {@code MarksheetBean} containing ID of the record to delete
     ...
     * @return the corresponding {@code MarksheetBean}, or null if not found
     * @throws ApplicationException if any exception occurs during the fetch
     */
     ...
     *
     * @param rollNo the roll number to search
     * @return the corresponding {@code MarksheetBean}, or null if not found
     * @throws ApplicationException if any exception occurs during the fetch
     */
	public MarksheetBean findByRollNo(String rollNo) throws ApplicationException {
	 ...
	 /**
     * Searches for Marksheet records based on criteria specified in the bean.
     * Also supports pagination.
     *
     * @param bean the {@code MarksheetBean} with search criteria
     * @param pageNo current page number
     * @param pageSize number of records per page
     * @return a list of matching {@code MarksheetBean} objects
     * @throws ApplicationException if any exception occurs during the search
     */
	public List<MarksheetBean> search(MarksheetBean bean, int pageNo, int pageSize) throws ApplicationException {
	 ...
	 /**
     * Retrieves the merit list of students who passed all subjects,
     * sorted by total marks in descending order.
     *
     * @param pageNo current page number
     * @param pageSize number of records per page
     * @return a list of top-performing {@code MarksheetBean} objects
     * @throws ApplicationException if any exception occurs during the fetch
     */
