...
/**
 * The UserModel class provides data access operations for UserBean.
 * It handles user management functionality such as registration, login, 
 * authentication, password management, and CRUD operations with the database.
 * 
 * This class also integrates with email utilities to send confirmation, 
 * registration, and password-related messages.
 * 
 * @author Sanjana Gangrade
 */
public class UserModel {
	  /**
     * Returns the next primary key from the st_user table.
     *
     ...
     * @throws ApplicationException if any exception occurs
     * @throws DuplicateRecordException if the login ID is duplicated
     */
     ...
     *
     * @param bean UserBean with ID to delete
     * @throws ApplicationException if any exception occurs
     */
     ...
     * @return UserBean with user details
     * @throws ApplicationException if any exception occurs
     */
     ...
     *
     * @param login login ID to search
     ...
     * @return UserBean if credentials match, otherwise null
     * @throws ApplicationException if any exception occurs
     */
    ...
    /**
     * Searches users based on the given search criteria and pagination.
     *
     * @param bean UserBean with search parameters
     * @param pageNo page number for pagination
     * @param pageSize number of records per page
     * @return list of matching UserBean objects
     * @throws ApplicationException if any exception occurs
     */
     ...
     * @throws RecordNotFoundException if the user does not exist or old password doesn't match
     * @throws ApplicationException if any exception occurs
     */
    ...
    /**
     * Sends the password to the registered email of the user if the login exists.
     *
     * @param login login ID (email)
     ...
     *
     * @param bean UserBean with user details
     * @return primary key of the registered user
     * @throws ApplicationException if any exception occurs
